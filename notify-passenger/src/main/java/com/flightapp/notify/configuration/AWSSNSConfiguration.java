 ...
 * com.amazonaws.services.sns.AmazonSNSClient; import
 * com.amazonaws.services.sns.AmazonSNSClientBuilder;
 * 
 * @Configuration public class AWSSNSConfiguration {
 * 
 ...
 * @Primary
 * 
 * @Bean public AmazonSNSClient amazonSNSclient() { return (AmazonSNSClient)
 * AmazonSNSClientBuilder.standard() .withRegion(region).withCredentials(new
 * AWSStaticCredentialsProvider( new BasicAWSCredentials(accessKey,
 * secretKey))).build(); }
 * 
 * }
 */